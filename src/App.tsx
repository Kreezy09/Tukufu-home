  ...
  const services = [
    {
      ...
      description:
        "Comprehensive educational programs focused on practical skills, digital literacy, and personal development. Our curriculum is designed to prepare youth for future opportunities in an ever-evolving world.",
      image: "/WhatsApp Image 2025-03-04 at 17.52.22 (2).jpeg",
    ...
    },
    {
      ...
      description:
        "One-on-one guidance from experienced mentors who provide support, share knowledge, and help youth navigate their personal and professional journeys with confidence.",
      image:
        "https://images.unsplash.com/photo-1531545514256-b1400bc00f31?auto=format&fit=crop&q=80",
    },
    {
      icon: Rocket,
      name: "Empowerment Initiatives",
      description:
        "Leadership development programs that build confidence, foster decision-making skills, and encourage youth to become active contributors to their communities.",
      image: "/WhatsApp Image 2025-03-04 at 17.52.28.jpeg",
    ...
    },
    {
      ...
      description:
        "Access to cutting-edge technologies and innovative solutions, providing hands-on experience with tools that are shaping the future of work and society.",
      image:
  ...
  const galleryImages = [
    {
      ...
      src: '/WhatsApp Image 2025-03-04 at 17.52.22.jpeg',
    ...
    },
    {
      ...
      src: '/WhatsApp Image 2025-03-04 at 17.52.28.jpeg',
      alt: 'STEM activity',
    ...
    <div className="min-h-screen">
      ...
      <div id="home" className="relative h-screen">
        ...
        <div
          ...
          style={{
            backgroundImage:
              'url("/WhatsApp Image 2025-03-04 at 17.52.22 (1).jpeg")',
          }}
        >
        ...
        <div className="relative h-full flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8 pt-16">
          <div className="text-center max-w-4xl mx-auto">
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-white mb-6 leading-tight">
              Uplifting Children and Youth through Training, Mentorship, and
              Empowerment
            </h1>
            <button
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Building on the strengths of children and youth to help them find
              hope, self-worth, and success in life.
            </p>
          </div>
          ...
          <div className="mb-20">
            <div className="bg-emerald-50 rounded-2xl p-8 max-w-4xl mx-auto">
              <p className="text-lg text-gray-700 leading-relaxed">
                At Tukufu, we believe in a holistic approach that nurtures the
                complete development of young minds. Through our innovative
                programs, we combine hands-on training with personalized
                mentorship to create transformative experiences. We expose youth
                to cutting-edge innovations and technologies, while building
                essential life skills that empower them to become confident,
      ...
      <div id="services" className="py-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Comprehensive programs designed to nurture potential and create
              lasting impact
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            {involvementOptions.map((option, index) => (
              ...
              >
                <option.icon
                  className={`w-12 h-12 ${option.iconColor} mx-auto mb-6`}
                />
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div className="flex items-center">
                    ...
                    <a
                      href="mailto:contact@tukufu.org"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-emerald-100 max-w-3xl mx-auto">
              We're working hard to bring you a full-featured website that will
              showcase more of what we do. Stay tuned!
            </p>
          </div>
